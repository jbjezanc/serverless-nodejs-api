...
Use this IAM policy for the [Serverless Framework](https://www.serverless.com/) with the AWS Provider for deploying Node.js apps as serverless functions on AWS Lambda.
